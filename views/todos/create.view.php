...
<form method="POST" action="/todo-create" class="p-5 w-75 mx-auto">
  ...
  <div class="form-group py-3">
    ...
    <input type="text" class="form-control" id="naslov" name="zadatak" placeholder="Vaš zadatak">
  </div>
  <div class="form-group py-3">
    <label for="body">Tijelo zadatka</label>
    <textarea class="form-control" id="body" name="body" rows="7" placeholder="Tekst zadatka...."></textarea>
  </div>
